...
$sql = "SELECT COUNT(*) as positiveCount FROM laboratory WHERE urinalysis_status = 'Positive' AND sex NOT IN ('male', 'female') AND mode_drug_use ='pwid' AND DATE_FORMAT(visitDate, '%Y-%m') = ?";
