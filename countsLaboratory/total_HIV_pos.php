...
$sql_female = "SELECT COUNT(*) as hepcCount FROM laboratory WHERE hiv_status = 'Positive' AND sex = 'female'";
...
$sql_male = "SELECT COUNT(*) as hepcCount FROM laboratory WHERE hiv_status = 'Positive' AND sex = 'male'";
...
$sql_other = "SELECT COUNT(*) as hepcCount FROM laboratory WHERE hiv_status = 'Positive' AND sex NOT IN ('male', 'female')";
