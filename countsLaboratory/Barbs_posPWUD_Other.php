...
$sql = "SELECT COUNT(*) as positiveCount FROM laboratory WHERE barbiturates = 'yes' AND sex NOT IN ('male', 'female') AND mode_drug_use ='pwud' AND DATE_FORMAT(visitDate, '%Y-%m') = ?";
