...
$sql = "SELECT COUNT(*) as positiveCount FROM laboratory WHERE pregnancy_status = 'Positive' AND sex NOT IN ('male', 'female') AND mode_drug_use ='pwud' AND DATE_FORMAT(visitDate, '%Y-%m') = ?";
