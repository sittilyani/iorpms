...
try {
    ...
    $sql = "
        SELECT
            p_id, comp_date, mat_id , clientName, hcw_name, next_appointment,
...
<head>
    <meta charset="UTF-8">
    <title>clinician Appointment Schedule</title>
            ...
            <?php else: ?>
                <?php foreach ($appointments as $app): ?>
                    <tr>
                        ...
                        <td>
                            <a href="update_clinician_appointment.php?p_id=<?= $app['p_id'] ?>"
