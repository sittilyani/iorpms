...
<div class="sidenav">
    <div>
        <img src="../assets/images/diary.png" alt="" style="height: 150px; width: 150px; margin-left:40px; margin-right: auto;">
    </div>
    <h2>
        <br>
        Appointments Diary
    ...
    <a href="../patients/view_appointment_patients.php" target="contentFrame" class="nav-link" style="background: #9EFF9E; color: #000000; margin-top: 10px;">
        <i class="fa fa-stethoscope"></i>Missed Appointments</a>

    <a href="../appointments/clinician_appointments.php" target="contentFrame" class="nav-link">
        <i class="fa fa-stethoscope"></i>Clinicians Appointments tomorrow</a>
    <a href="../appointments/laboratory_appointments.php" target="contentFrame" class="nav-link">
        <i class="fa fa-eyedropper"></i>Laboratory Appointments tomorrow</a>
    <a href="../appointments/nursing_appointments.php" target="contentFrame" class="nav-link">
        <i class="fa fa-medkit"></i>Nursing Appointments tomorrow</a>
    <a href="../appointments/nutritionist_appointments.php" target="contentFrame" class="nav-link">
        <i class="fa fa-coffee"></i>Nutritionists Appointments tomorrow</a>
    <a href="../appointments/psychologists_appointments.php" target="contentFrame" class="nav-link">
        <i class="fa fa-ban"></i>Psychosocial Appointments tomorrow</a>
    <a href="../appointments/psychiatric_appointments.php" target="contentFrame" class="nav-link">
        <i class="fa fa-user-md"></i>Psychiatric Appointments tomorrow</a>
    <a href="../appointments/records_appointments.php" target="contentFrame" class="nav-link">
        <i class="fa fa-edit"></i>Health Records Appointments tomorrow</a>
    <a href="../appointments/admin_appointments.php" target="contentFrame" class="nav-link">
        <i class="fa fa-edit"></i>Admin Appointments tomorrow</a>
