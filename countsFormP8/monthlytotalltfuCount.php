...
$sql_female = "SELECT COUNT(*) as ltfuCount FROM patients WHERE current_status = 'ltfu'
                    AND sex = 'female'
...
$sql_male = "SELECT COUNT(*) as ltfuCount FROM patients WHERE current_status = 'ltfu'
                AND sex = 'male'
                AND MONTH(comp_date) = MONTH(CURRENT_DATE())
                AND YEAR(comp_date) = YEAR(CURRENT_DATE())";
...
$sql_other = "SELECT COUNT(*) as ltfuCount FROM patients WHERE current_status = 'ltfu'
