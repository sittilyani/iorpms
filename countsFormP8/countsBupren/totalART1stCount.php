...
$sql_female = "SELECT COUNT(*) as pepCount FROM patient WHERE status = 'pep' AND sex = 'female' AND drugname LIKE 'buprenorphine%'";
...
$sql_male = "SELECT COUNT(*) as pepCount FROM patient WHERE status = 'pep' AND sex = 'male' AND drugname LIKE 'buprenorphine%'";
...
$sql_other = "SELECT COUNT(*) as pepCount FROM patient WHERE status = 'pep' AND sex = 'other' AND drugname LIKE 'buprenorphine%'";
