...
$sql_female = "SELECT COUNT(*) as activeCount FROM patients WHERE current_status = 'active' AND sex = 'female' AND drugname LIKE 'buprenorphine%'";
...
$sql_male = "SELECT COUNT(*) as activeCount FROM patients WHERE current_status = 'active' AND sex = 'male' AND drugname LIKE 'buprenorphine%'";
...
$sql_other = "SELECT COUNT(*) as activeCount FROM patients WHERE current_status = 'active' AND sex NOT IN ('male', 'female') AND drugname LIKE 'buprenorphine%'";
