...
$sql_female = "SELECT COUNT(*) as pepCount FROM medical_history WHERE other_status = 'PEP' AND sex = 'female' ";
...
$sql_male = "SELECT COUNT(*) as pepCount FROM medical_history WHERE other_status = 'PEP' AND sex = 'male' ";
...
$sql_other = "SELECT COUNT(*) as pepCount FROM medical_history WHERE other_status = 'PEP' AND sex NOT IN ('male', 'female') ";
