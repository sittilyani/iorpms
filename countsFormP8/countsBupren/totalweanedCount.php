...
$sql_female = "SELECT COUNT(*) as weanedCount FROM patients WHERE current_status = 'weaned' AND sex = 'female' AND drugname LIKE 'buprenorphine%'";
...
$sql_male = "SELECT COUNT(*) as weanedCount FROM patients WHERE current_status = 'weaned' AND sex = 'male' AND drugname LIKE 'buprenorphine%'";
...
$sql_other = "SELECT COUNT(*) as weanedCount FROM patients WHERE current_status = 'weaned' AND sex NOT IN ('male', 'female') AND drugname LIKE 'buprenorphine%'";
