...
$sql_female = "SELECT COUNT(*) as missed_lineCount FROM patients WHERE current_status = 'defaulted' AND sex = 'female' AND drugname LIKE 'buprenorphine%'";
...
$sql_male = "SELECT COUNT(*) as missed_lineCount FROM patients WHERE current_status = 'defaulted' AND sex = 'male' AND drugname LIKE 'buprenorphine%'";
...
$sql_other = "SELECT COUNT(*) as missed_lineCount FROM patients WHERE current_status = 'defaulted' AND sex NOT IN ('male', 'female') AND drugname LIKE 'buprenorphine%'";
