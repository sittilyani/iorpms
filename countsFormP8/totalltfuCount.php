...
$sql_female = "SELECT COUNT(*) as ltfuCount FROM patients WHERE current_status = 'ltfu' AND sex = 'female' AND drugname ='methadone'";
...
$sql_male = "SELECT COUNT(*) as ltfuCount FROM patients WHERE current_status = 'ltfu' AND sex = 'male' AND drugname ='methadone'";
...
$sql_other = "SELECT COUNT(*) as ltfuCount FROM patients WHERE current_status = 'ltfu' AND sex NOT IN ('male', 'female') AND drugname ='methadone'";
