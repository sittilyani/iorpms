...
$sql_female = "SELECT COUNT(*) as weanedCount FROM patients WHERE current_status = 'weaned'
                    AND sex = 'female'
...
$sql_male = "SELECT COUNT(*) as weanedCount FROM patients WHERE current_status = 'weaned'
                AND sex = 'male'
                AND MONTH(comp_date) = MONTH(CURRENT_DATE())
                AND YEAR(comp_date) = YEAR(CURRENT_DATE())";
...
$sql_other = "SELECT COUNT(*) as weanedCount FROM patients WHERE current_status = 'weaned'
