...
$sql_female = "SELECT COUNT(*) as transitCount FROM patients WHERE current_status = 'transit' AND sex = 'female' AND drugname ='methadone'";
...
$sql_male = "SELECT COUNT(*) as transitCount FROM patients WHERE current_status = 'transit' AND sex = 'male' AND drugname ='methadone'";
...
$sql_other = "SELECT COUNT(*) as transitCount FROM patients WHERE current_status = 'transit' AND sex NOT IN ('male', 'female') AND drugname ='methadone'";
