...
$sql_female = "SELECT COUNT(*) as deadCount FROM patients WHERE current_status = 'dead' AND sex = 'female' AND drugname ='methadone'";
...
$sql_male = "SELECT COUNT(*) as deadCount FROM patients WHERE current_status = 'dead' AND sex = 'male' AND drugname ='methadone'";
...
$sql_other = "SELECT COUNT(*) as deadCount FROM patients WHERE current_status = 'dead' AND sex NOT IN ('male', 'female') AND drugname ='methadone'";
