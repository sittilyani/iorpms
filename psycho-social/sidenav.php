...
<div class="sidenav">
    <div>
        <img src="../assets/images/learning.png" alt="" style="height: 150px; width: 150px; margin-left:40px; margin-right: auto;">
    </div>
    <h2>
        <br>
        Psycho-social
    ...
    <a href="../psycho-social/search_psychiatric_encounter_form.php" target="contentFrame" class="nav-link">
