...
<body>
    <h2 style="color: #2C3162; ">Psychiatric Encounter Form Client Search</h2>
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>
                        ...
                        <td>
                            ...
                            <a href='psychiatric_encounter_form.php?mat_id=" . htmlspecialchars($row['mat_id']) . "'>Check In Client</a>
                        </td>
                    </tr>";
        }
        echo "</tbody></table>";
