        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if (!empty($row['consent_id'])) {
                    echo "<a href='../psycho-social/update_consent.php?consent_id=" . $row['consent_id'] . "&mat_id=" . $row['mat_id'] . "' class='update-link'>Update Consent</a>";
                } else {
                    echo "<a href='../psycho-social/create_consent.php?p_id=" . $row['p_id'] . "' class='update-link'>Create Consent</a>";
                }
