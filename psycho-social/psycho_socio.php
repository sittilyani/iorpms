...
<body>
    <h2 style="color: #2C3162; ">Psycho Socio Daily Activity Register</h2>
...
<!--This is the search Form -->
    ...
    $sql = "SELECT * FROM patients WHERE (mat_id LIKE '%$search%'
            ...
            AND current_status IN ('Active', 'LTFU', 'ltfu', 'Defaulted')";
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>
                    ...
                    <td>
                        ...
                        <a href='PsychoDAR_updated.php?p_id=" . $row['p_id'] . "'>Serve Client</a> &#124;
