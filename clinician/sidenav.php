...
<div class="sidenav">
    <div>
        <img src="../assets/images/doctor.png" alt="" style="height: 150px; width: 150px; margin-left:40px; margin-right: auto;">
    </div>
    <h2>
        <br>
    ...
    <a href="../appointments/update_appointments.php" target="contentFrame" class="nav-link" style="background: #9EFF9E; color: #000000; margin-top: 10px; margin-bottom: 10px;">
                    <i class="fa fa-stethoscope"></i>Update Appointments</a>
        
    <a href="../clinician/update_dose.php" target="contentFrame" class="nav-link" style="background: yellow; color: #000000;">
    ...
    <a href="../clinician/search_yellow_card.php" target="contentFrame" class="nav-link" style="background: yellow; margin-top: 10px; color: #000000;">
        <i class="fa fa-card"></i>Clinian Yellow Card</a>
    <a href="../clinician/clinician_follow_up_form.php" target="contentFrame" class="nav-link" style="background: #cff0ce; margin-top: 10px; color: #000000;">
        <i class="fa fa-stethoscope"></i>ART Clinical Follow Up</a>
