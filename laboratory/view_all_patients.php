...
<body>
    <h2 style="color: #2C3162; ">Laboratory Form</h2>
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<table border='1'>
                <tr>
                    ...
                    <th>MAT ID</th>
                    <th style='width: 120px;'>MAT Number</th>
                    <th>Client Name</th>
                    <th style='width: 80px;'>Age</th>
                    <th style='width: 80px;'>Sex</th>
                    <th>Physical Address</th>
                    <th style='width: 130px;'>CSO</th>
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>
                    ...
                    <td>
                        <a href='../patients/view_patient.php?p_id=" . $row['p_id'] . "'>View details</a> &#124;
                        <a href='labdar.php?p_id=" . $row['p_id'] . "'>Check In</a> &#124;
