...
<div class="sidenav">
    <h2>
        <i class="fas fa-cog settings-icon"></i><br>
    ...
    <a href="../public/user_registration.php?username=<?php echo $username; ?>" target="contentFrame" class="nav-link">
        <i class="fas fa-user-plus"></i> Add users</a>

    <a href="../public/userslist.php?username=<?php echo $username; ?>" target="contentFrame" class="nav-link">
        <i class="fas fa-users"></i> View users</a>
</div>
...
<div class="main">
    ...
    <div class="content-area">
        ...
        <div class="welcome-message" id="welcomeMessage">
            ...
            <p>Select an option from the side navigation to manage settings. Your access level is: <strong><?php echo ucfirst($userrole); ?></strong></p>
