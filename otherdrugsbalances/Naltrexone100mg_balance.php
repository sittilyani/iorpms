<p>
                <?php
                    ...
                    $sql = "SELECT stock_movements.total_qty AS total_qty
                            ...
                            WHERE drug.drugID = 10
                            AND drug.drugName = 'Naltrexone 100mg'
                    ...
                    if ($result) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            // Output the result
                            echo '<p>Naltrexone 100mg Balance: <span style="font-weight: bold; color: #000099;">' . $row['total_qty'] . '&nbsp;tablets</strong></p>';
                        } else {
                            echo '<p>No Naltrexone 100mg stock records found.</p>';
                        }
                    } else {
