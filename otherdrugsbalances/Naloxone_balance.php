<p>
                <?php
                    ...
                    $sql = "SELECT stock_movements.total_qty AS total_qty
                            ...
                            WHERE drug.drugID = 12
                            AND drug.drugName = 'Naloxone 1mg/mL inj'
                    ...
                    if ($result) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            // Output the result
                            echo '<p>Naloxone 1mg inj Balance: <span style="font-weight: bold; color: #000099;">' . $row['total_qty'] . '&nbsp;Ampoules</strong></p>';
                        } else {
                            echo '<p>No Naloxone 1mg inj stock records found.</p>';
                        }
                    } else {
