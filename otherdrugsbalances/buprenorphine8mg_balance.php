                ...
                <?php
                    ...
                    if ($result) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            // Output the result
                            echo '<p>Buprenorphine 8mg Balance: <span style="font-weight: bold; color: #000099;">' . $row['total_qty'] . '&nbsp;tablets</strong></p>';
                        } else {
                            echo '<p>No Buprenorphine 8mg stock records found.</p>';
                        }
                    } else {
