...
<body>
    ...
    <div class="header">
        ...
        All:&nbsp;&nbsp;<span style="font-weight: normal; color: green;" ><?php include '../counts/new_patient_count.php'; ?></span><br>
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>
                    <td>" . $row['p_id'] . "</td>
                    <td style='width: 140px; min-width: 100px; max-width: 140px;'>" . $row['mat_id'] . "</td>
                    <td style='width: 140px; min-width: 100px; max-width: 140px;'>" . $row['mat_number'] . "</td>
                    <td style='width: 200px; min-width: 100px; max-width: 200px;'>" . $row['clientName'] . "</td>
                    <td style='width: 100px; min-width: 70px; max-width: 100px;'>" . $row['nickName'] . "</td>
                    <td>" . $row['dob'] . "</td>
                    <td>" . $row['reg_date'] . "</td>
                    <td>" . $row['age'] . "</td>
                    <td>" . $row['sex'] . "</td>
                    <td style='width: 100px; min-width: 70px; max-width: 100px;'>" . $row['p_address'] . "</td>
                    <td style='width: 70px; min-width: 70px; max-width: 70px;'>" . $row['cso'] . "</td>
                    <td>" . $row['drugname'] . "</td>
                    <td>" . $row['dosage'] . "</td>
