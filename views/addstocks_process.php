...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO pharmacy (drugName, stockqty, stockedDate, expiryDate)
            VALUES (?, ?, ?, ?)";
    ...
    // Bind parameters
    $stmt->bind_param('siss', $drugName, $stockqty, $stockedDate, $expiryDate);  // Assuming stockqty is an integer
