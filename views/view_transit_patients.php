...
<body>
    <h2 style="color: #2C3162; ">All transit Patients List</h2>
    ...
    <div class="header">
        ...
        transit:&nbsp;&nbsp;<span style="font-weight: normal; color: red;" ><?php include '../counts/transit_patient_count.php'; ?></span><br>
    </div>
    </form>
    ...
    $sql = "SELECT * FROM patients
            ...
            AND mat_status = 'transit' AND current_status = 'active' ";
