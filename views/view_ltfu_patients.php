    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>
                    <td>" . $row['p_id'] . "</td>
                    <td>" . $row['mat_id'] . "</td>
                    <td style='width: 200px;'>" . $row['clientName'] . "</td>
                    <td style='width: 120px;'>" . $row['dob'] . "</td>
                    <td style='width: 120px;'>" . $row['reg_date'] . "</td>
                    <td>" . $row['age'] . "</td>
                    <td>" . $row['sex'] . "</td>
                    <td>" . $row['p_address'] . "</td>
                    <td style='width: 50px;'>" . $row['cso'] . "</td>
                    <td>" . $row['drugname'] . "</td>
                    <td>" . $row['dosage'] . "</td>
                    <td style='width: 150px; color: red;'>" . (!empty($row['visitDate']) ? htmlspecialchars($row['visitDate']) :  "No visit Date") . "</td>
                    <td style='color:red; font-weight: bold; text-align: center;'>" . ($row['days_ltfu'] !== null ? $row['days_ltfu'] : 'N/A') . "</td>
