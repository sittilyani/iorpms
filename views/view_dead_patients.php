...
<body>
    <h2 style="color: #2C3162; ">All dead Patients List</h2>
    ...
    <div class="header">
        ...
        dead:&nbsp;&nbsp;<span style="font-weight: normal; color: red;" ><?php include '../counts/dead_patient_count.php'; ?></span><br>
    </div>
    </form>
