...
<body>
    <h2 style="color: #2C3162; ">All new Patients List</h2>
    ...
    <div class="header">
        ...
        new:&nbsp;&nbsp;<span style="font-weight: normal; color: red;" ><?php include '../counts/new_patient_count.php'; ?></span><br>
    </div>
    </form>
