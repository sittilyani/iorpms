...
if ($stmt) {
    ...
    if ($result) {
        ...
        if ($total_dosage === null || $total_dosage == 0) {
            ...
            echo '<p>buprenorphine 4mg dispensed on ' . htmlspecialchars($current_display_date) . ': <span style="font-weight: bold; color: red;">' . htmlspecialchars($total_dosage) . '&nbsp;mg</span></p>';
        }
    } else {
