...
$languages = [
    ...
    'en' => [
        ...
        'dispense_without_pump' => 'Dispense without Pump',
        ...
        'volume_ml'         => 'Volume (mL)',
        'dosage_mg'         => 'Dosage (mg)',
        'dosing_pattern'    => 'Dosing Pattern',
        'dosing_daily'      => 'Daily (every day)',
        'dosing_alt_day'    => 'Alternate Day (every 2 days)',
        'dosing_every_3'    => 'Every 3 Days',
        'dosing_every_4'    => 'Every 4 Days',
        'dosing_custom'     => 'Custom (use skip dates)',
        'not_due'           => 'Not Due (Alternate Dosing)',
    ...
    'fr' => [
        ...
        'dosage'            => 'Dosage',
        'update_dosage'     => 'Mettre à jour le dosage',
        ...
        'dispense_without_pump' => 'Dispenser sans pompe',
        ...
        'volume_ml'         => 'Volume (mL)',
        'dosage_mg'         => 'Dosage (mg)',
        'dosing_pattern'    => 'Schéma de dosage',
        'dosing_daily'      => 'Quotidien (tous les jours)',
        'dosing_alt_day'    => 'Un jour sur deux (tous les 2 jours)',
        'dosing_every_3'    => 'Tous les 3 jours',
        'dosing_every_4'    => 'Tous les 4 jours',
        'dosing_custom'     => 'Personnalisé (dates à ignorer)',
        'not_due'           => 'Non dû (dosage alterné)',
    ...
    'pt' => [
        ...
        'dosage'            => 'Dosagem',
        'update_dosage'     => 'Atualizar Dosagem',
        ...
        'dispense_without_pump' => 'Distribuir sem Bomba',
        ...
        'dosing_pattern'    => 'Padrão de Dosagem',
        'dosing_daily'      => 'Diário (todos os dias)',
        'dosing_alt_day'    => 'Dia Alternado (a cada 2 dias)',
        'dosing_every_3'    => 'A cada 3 Dias',
        'dosing_every_4'    => 'A cada 4 Dias',
        'dosing_custom'     => 'Personalizado (usar datas a ignorar)',
        'not_due'           => 'Não Devido (Dosagem Alternada)',
