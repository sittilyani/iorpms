...
<head>
        ...
        <link rel="stylesheet" href="../assets/css/all-6.4.0.min.css" onerror="this.onerror=null;this.href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css'">
...
<body>
        ...
        <div class="footer">
                <div class="footer-content">
                        <span>EasyFlow-L: an Integrated Opioid Replacement Patient Management System - developed by lvcthealth &copy;&nbsp; <?php echo date('Y');?></span>
