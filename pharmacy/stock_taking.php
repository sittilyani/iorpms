...
<head>
    ...
    <!-- Tailwind: no local copy; loaded from CDN as page uses Tailwind classes -->
    <script src="../assets/js/tailwind-cdn.js" onerror="this.onerror=null;this.src='https://cdn.tailwindcss.com'" defer></script>
    <style>
