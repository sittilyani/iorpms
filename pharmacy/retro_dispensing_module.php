...
<html>
<head>
    <title>Retrospective - Bulk Dispensing</title>
...
<body>
    <h2 style="color: #2C3162;">Retrospective - Bulk Dispensing</h2>
    ...
    if (isset($_GET['start_date'])) {
        ...
        if (strtotime($startDate) > strtotime($endDate)) {
            ...
            if ($inmatesResult && $inmatesResult->num_rows > 0) {
                ...
                echo '<label for="pharm_officer_name" style="font-weight: bold;">Name of officer updating records:</label>';
                echo '<input type="text" style="margin-left: 30px; width: 400px; border-radius: 10px; heigth: 45px; padding: 10px;" id="pharm_officer_name" name="pharm_officer_name" placeholder="insert the name of officer updating records" required>';
                echo '</div>';
