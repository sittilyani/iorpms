...
<body>
    <div class="container">
        ...
        <div class="stats-container">
            ...
            <!--Hidden clinic appointment date -->
            ...
            <div class="stat-item stat-prescription">
                <a href="../pharmacy/view_prescriptions.php">
                <?php include ('../counts/prescription_count.php'); ?>
                    </a></span> <!-- This would be your PHP count --><br>
                ...
                <div>
                    ...
                    <div class="prescriptions-container">
                        ...
                        <table class="prescriptions-table">
                            ...
                            <tbody>
                                <?php foreach ($otherPrescriptions as $index => $prescription): ?>
                                <tr>
                                    ...
                                    <td><input type="checkbox" name="dispense[<?php echo $index; ?>]" value="1"></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
