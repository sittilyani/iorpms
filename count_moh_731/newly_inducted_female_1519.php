...
$sql = "SELECT COUNT(*) as everinductedallCount FROM patients WHERE mat_status = 'new'  AND age BETWEEN 15 AND 19 AND sex = 'female' AND age BETWEEN 15 AND 19 AND reg_date BETWEEN ? AND ?";
