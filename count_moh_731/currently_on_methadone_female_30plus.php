...
$sql = "SELECT COUNT(*) as everinductedallCount FROM patients WHERE current_status IN ('active', 'defaulted') AND sex = 'female' AND age >= 30 AND drugname = 'methadone' AND reg_date BETWEEN ? AND ?";
