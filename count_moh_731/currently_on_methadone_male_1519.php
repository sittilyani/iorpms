...
$sql = "SELECT COUNT(*) as everinductedallCount FROM patients WHERE current_status IN ('active', 'defaulted')  AND  sex = 'male' AND age BETWEEN 15 AND 19 AND drugname = 'methadone' AND reg_date BETWEEN ? AND ?";
