...
$sql = "SELECT COUNT(*) as everinductedallCount FROM patients WHERE current_status IN ('active', 'defaulted') AND sex = 'female' AND age BETWEEN 25 AND 29 AND drugname = 'methadone' AND reg_date BETWEEN ? AND ?";
