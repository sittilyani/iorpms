...
<body>
    ...
    <form id="searchForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="GET">
        <div class="header">
            ...
            <a href="../patients/add_clients.php" class="button" style="border-radius: 5px; border: none; background: blue; color: #ffffff; cursor: pointer; font-size: 16px; padding: 5px;" >Register New Client</a>
        </div>
    </form>
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>
                    ...
                    <td>
                        ...
                        <a href='../records/health_records_referral.php?mat_id=" . htmlspecialchars($row['mat_id']) . "'>Refer</a>
                    </td>
                </tr>";
        }
        echo "</tbody></table>";
