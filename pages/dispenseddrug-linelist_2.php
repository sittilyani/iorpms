...
echo "<div class='filter-form-container' style='font-family: Times New Roman; width: 70%;'>";
echo "<h3 style='color: #1a5276; margin-bottom: 10px;'>Drugs Dispensed By Date</h3>";
echo "<form method='get' style='background-color: #1a5276; color: white; padding: 15px; border-radius: 5px;'>";
