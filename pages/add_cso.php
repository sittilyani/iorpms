...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $cso_name = $_POST['cso_name']; // Assuming the form field name is CSO
    $description = $_POST['description'];
    // Validate data (you can add more validation as needed)

    // Insert data into tblcso table
    $sql = "INSERT INTO tblcso (cso_name, description) VALUES ('$cso_name', '$description')";

    if ($conn->query($sql) === TRUE) {
        echo "New CSO created successfully";
    } else {
...
<body>
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <input type="text" id="cso_name" name="cso_name" required>

        <label for="description">Description:</label>
        <textarea id="decsription" name="description" rows="4" cols="50"></textarea>

        <input type="submit" value="Submit" class="custom-submit-btn">
    </form>
</body>
</html>
