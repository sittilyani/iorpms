...
<body>
    <h2 style="color: #2C3162; ">FORM 3C - MEDICALLY ASSISTED THERAPY - PATIENT TREATMENT CARD VER. APRIL 2023</h2>
    ...
    <div class="header">
        ...
        WorkLoad:&nbsp;&nbsp;<span style="font-weight: normal; color: red;" ><?php include '../counts/clinic_patient_visits_count.php'; ?></span><br>
        <button
