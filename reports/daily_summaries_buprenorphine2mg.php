...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .form-header{background: #7ad2f0; color:#000000;padding:30px 40px;display:grid;grid-template-columns:100px 1fr 150px;align-items:center;gap:20px}
        ...
        thead{background:#7ad2f0;color:#000000;}
